...
(function() {
    ...
    jsork.kingdom.getPlayers = function(kingdomId, filter, token) {
      var promise = new Promise(function(resolve) {
        var request =
            {
              Token: token,
    ...
    jsork.park.getPlayers = function(parkID, filter, token) {
      var promise = new Promise(function(resolve) {
        var request =
            {
              Id: parkID,
    ...
    jsork.polarisVotingOriginal = function() {
